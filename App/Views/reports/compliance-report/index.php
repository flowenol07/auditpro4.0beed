    ...
    sizeof($data['data']['data_array']['ans_data']) > 0 )
{
    echo '<div id="printContainer">' . "\n";
        ...
        echo '<style>
            ...
            .audit-report-table > tbody > tr > th:nth-child(4), .audit-report-table > tbody > tr > td:nth-child(4) { width:20% }
            .audit-report-table > tbody > tr > th:nth-child(5), .audit-report-table > tbody > tr > td:nth-child(5) { width:8% }
