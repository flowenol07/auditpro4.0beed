    ...
    sizeof($data['data']['data_array']['ans_data']) > 0 )
{
    echo '<div id="printContainer">' . "\n";
        ...
        echo '<style>
            ...
            .audit-report-table > tbody > tr > th:nth-child(2), .audit-report-table > tbody > tr > td:nth-child(2) { width:50% }
            .audit-report-table > tbody > tr > th:nth-child(3), .audit-report-table > tbody > tr > td:nth-child(3) { width:10% }
            .audit-report-table > tbody > tr > th:nth-child(4), .audit-report-table > tbody > tr > td:nth-child(4) { width:30% }
