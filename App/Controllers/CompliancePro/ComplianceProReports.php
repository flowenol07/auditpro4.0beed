...
class ComplianceProReports extends Controller  {
    ...
    public function index() 
    {
        //top btn array
        $this -> data['topBtnArr'] = [
            'default' => [ 'href' => SiteUrls::getUrl('complianceProDashboard') ]
        ];
        ...
        if($this -> empType != 3)
            $this -> data['reports'] = [
                'master_reports' => [
                    ...
                    'reports' => [ 'complianceAuthorityReport', 'complianceCircularsReport',]
                ]
            ];
        else
            $this -> data['reports'] = [];
        ...
        $this -> data['reports']['audit_reports'] = [
            ...
            'reports' => [ 
                'complianceStatusReport'/*, 'complianceProSummaryReport', 'nonComplianceEscalationReport'*/
            ]
        ];
