...
class RiskCompositeModel extends Model {

    protected static $table = 'risk_composite';
    ...
    public function getAllRiskComposite($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
        return get_all_data_query_builder(2, $this -> _db, self::$table, $filters, $query_type, $sql);
    }

    public function getSingleRiskComposite($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
