...
class CategoryModel extends Model {
    ...
    protected static $table = 'category_master';
    ...
    public function getAllCategory($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
        return get_all_data_query_builder(2, $this -> _db, self::$table, $filters, $query_type, $sql);
    }

    public function getSingleCategory($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
