...
class RiskCategoryWeightModel extends Model {

    protected static $table = 'risk_category_weights';
    ...
    public function getAllRiskCategoryWeight($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
        return get_all_data_query_builder(2, $this -> _db, self::$table, $filters, $query_type, $sql);
    }

    public function getSingleRiskCategoryWeight($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
