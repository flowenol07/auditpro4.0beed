...
class DumpAdvancesModel extends Model {

    protected static $table = 'dump_advances';
    ...
    public function getAllAccounts($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
        return get_all_data_query_builder(2, $this -> _db, self::$table, $filters, $query_type, $sql);
    }

    public function getSingleAccount($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
