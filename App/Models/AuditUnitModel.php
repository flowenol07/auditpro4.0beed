...
class AuditUnitModel extends Model {

    protected static $table = 'audit_unit_master';
    ...
    public function getAllAuditUnit($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
        return get_all_data_query_builder(2, $this -> _db, self::$table, $filters, $query_type, $sql);
    }

    public function getSingleAuditUnit($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
