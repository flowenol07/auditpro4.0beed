...
class AnnexureColumnModel extends Model {

    protected static $table = 'annexure_columns';
    ...
    public function getAllAnnexureColumns($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
        return get_all_data_query_builder(2, $this -> _db, self::$table, $filters, $query_type, $sql);
    }

    public function getSingleAnnexureColumns($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
