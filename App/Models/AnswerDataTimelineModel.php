...
class AnswerDataTimelineModel extends Model {

    protected static $table = 'answers_data_timeline';
    ...
    public function getAllAnswersTimeline($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
        return get_all_data_query_builder(2, $this -> _db, self::$table, $filters, $query_type, $sql);
    }

    public function getSingleAnswerTimeline($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
