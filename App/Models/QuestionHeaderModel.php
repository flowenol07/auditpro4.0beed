...
class QuestionHeaderModel extends Model {

    protected static $table = 'question_header_master';
    ...
    public function getAllQuestionHeader($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
        return get_all_data_query_builder(2, $this -> _db, self::$table, $filters, $query_type, $sql);
    }

    public function getSingleQuestionHeader($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
