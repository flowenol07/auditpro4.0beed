...
class ComplianceCircularTaskModel extends Model {

    protected static $table = 'com_circular_task_master';
    ...
    public function getAllCircularTask($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
        return get_all_data_query_builder(2, $this -> _db, self::$table, $filters, $query_type, $sql);
    }

    public function getSingleCircularTask($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
