...
class SchemeModel extends Model {
    ...
    protected static $table = 'scheme_master';
    ...
    public function getAllSchemes($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
        return get_all_data_query_builder(2, $this -> _db, self::$table, $filters, $query_type, $sql);
    }

    public function getSingleScheme($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
