...
class ComplianceCircularTaskSetModel extends Model {

    protected static $table = 'com_circular_multi_control_task_set';
    ...
    public function getAllCircularTaskSetData($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
        return get_all_data_query_builder(2, $this -> _db, self::$table, $filters, $query_type, $sql);
    }

    public function getSingleCircularTaskSetData($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
