...
class AuditAssesmentTimelineModel extends Model {

    protected static $table = 'audit_assesment_timeline';
    ...
    public function getAllAuditAssesmentTimeline($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
        return get_all_data_query_builder(2, $this -> _db, self::$table, $filters, $query_type, $sql);
    }

    public function getSingleAuditAssesmentTimeline($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
