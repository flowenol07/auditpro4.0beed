...
class QuestionMasterModel extends Model {
    ...
    protected static $table = 'question_master';
    ...
    public function getAllQuestions($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
        return get_all_data_query_builder(2, $this -> _db, self::$table, $filters, $query_type, $sql);
    }

    public function getSingleQuestion($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
