...
class ReportScoringMasterModel extends Model {

    protected static $table = 'report_scoring_master';
    ...
    public function getAllReportScore($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
        return get_all_data_query_builder(2, $this -> _db, self::$table, $filters, $query_type, $sql);
    }

    public function getSingleReportScore($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
