...
class AnswerDataModel extends Model {

    protected static $table = 'answers_data';
    ...
    public function getAllAnswers($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
        return get_all_data_query_builder(2, $this -> _db, self::$table, $filters, $query_type, $sql);
    }

    public function getSingleAnswer($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
