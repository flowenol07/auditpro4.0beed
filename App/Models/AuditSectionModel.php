...
class AuditSectionModel extends Model {

    protected static $table = 'audit_section_master';
    ...
    public function getAllAuditSection($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
        return get_all_data_query_builder(2, $this -> _db, self::$table, $filters, $query_type, $sql);
    }

    public function getSingleAuditSection($filters = [], $query_type = null, $sql = '')
    {
        //database helper function call
